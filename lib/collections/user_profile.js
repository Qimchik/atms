Meteor.methods({
  ...
  singup: function(submittedData) {
    ...
    if (userId) {
      Meteor.users.update({_id: userId}, {$set: {skype: submittedData.skype, firstName: submittedData.firstName, 
        lastName: submittedData.lastName, dateOfBirth: submittedData.dateOfBirth, nickname: submittedData.nickname, 
        mobPhone: submittedData.mobPhone, emergencyPhone: submittedData.emergencyPhone, address: submittedData.address}});
    }
    return userId;
  },
